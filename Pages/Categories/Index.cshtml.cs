...
using Bumb_Alexandru_Flaviu_Lab2.Models.ViewModels;
...
namespace Bumb_Alexandru_Flaviu_Lab2.Pages.Categories
{
    public class IndexModel : PageModel
    {
        ...
        public async Task OnGetAsync(int? id, int? bookID)
        {
            ...
            CategoryData.Categories = await _context.Category.Include(i => i.BookCategories).ThenInclude(i => i.Book).ThenInclude(i => i.Author).OrderBy(i => i.CategoryName).ToListAsync();
            if (id != null)
            {
                CategoryID = id.Value;
