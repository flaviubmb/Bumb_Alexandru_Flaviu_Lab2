...
namespace Bumb_Alexandru_Flaviu_Lab2.Data
{
    public class Bumb_Alexandru_Flaviu_Lab2Context : DbContext
    {
        ...
        public DbSet<Bumb_Alexandru_Flaviu_Lab2.Models.Category> Category { get; set; } = default!;
        public DbSet<Bumb_Alexandru_Flaviu_Lab2.Models.Member> Member { get; set; } = default!;
        public DbSet<Bumb_Alexandru_Flaviu_Lab2.Models.Borrowing> Borrowing { get; set; } = default!;
    }
}
